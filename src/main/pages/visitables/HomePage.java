...
public final class HomePage implements Page {
    private ArrayList<SongSortingHelper> likedSongs = new ArrayList<>();
    ...
    public ArrayList<SongSortingHelper> getLikedSongs() {
        return likedSongs;
    }

    public void setLikedSongs(final ArrayList<SongSortingHelper> likedSongs) {
