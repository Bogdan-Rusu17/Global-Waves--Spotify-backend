...
public final class AddHostUserCommand extends AddUserCommand {
    public AddHostUserCommand(final Command command) {
        super(command);
    }
    ...
    public void execCommand() {
        ...
        Host newHost = new Host(this.getUsername(), this.getAge(), this.getCity());
        GlobalObjects.getInstance().getLibrary().getHosts().add(newHost);
        this.getObjectNode().put("message", "The username "
